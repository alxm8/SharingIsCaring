###-sells eth from a portfolio in coinbase pro at the market rate for GBP
##-summary
...
$transaction = New-CoinbaseProMarketOrder -APIKey $CBAPIKey.key  -APISecret $CBAPIKey.Secret  -APIPhrase $CBAPIKey.phrase -Side sell -Size $ethaccount.balance -ProductID ETH-GBP
